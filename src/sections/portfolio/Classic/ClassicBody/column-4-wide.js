  ...
  <div className="container-fluid">
    <div className="row justify-content-center">
      <div className="col-12">
        <div className="iso-mas-grid-wrap row gx-0 justify-content-center">
        {filteredImages.map(({image,id,tagi}) => (
						<div className={`col-xl-3 col-lg-4 col-md-6  col-sm-6 gr-pb-0  ${tagi === tag | tag === "all" ?  "is-animated" :""} `}  key={id}>
            <Card image={image}/>
          </div>
					))}
